...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Persist minimal user info for existing route guard
      ...
      // Show global loader only for Login -> Dashboard transition
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center space-x-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-60"
          >
          ...
          <div className="text-center text-sm text-gray-600 leading-relaxed">
            <p>Sign in with your Google account to access Cliniscribe&apos;s AI health assistant</p>
